$(document).ready (function() {
  $(".tweet-list").on("mouseenter", ".tweet-container", function(event) {
...
// .addClass adds the specified class to each element in the set of matched elemnts, in this case this, which is referencing the html element <article> with the class "tweet-container highlight"
